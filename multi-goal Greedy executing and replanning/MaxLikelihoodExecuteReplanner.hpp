#ifndef MAXLIKELIHOODEXECUTEREPLANNER_H
#define MAXLIKELIHOODEXECUTEREPLANNER_H
...
class MaxLikelihoodExecuteReplanner_t
{
	int m_nReplan;
...
public:
	// Constructor
	MaxLikelihoodExecuteReplanner_t() {}
	MaxLikelihoodExecuteReplanner_t(ConnectedGraph_t &g, std::vector<int> currentPath);
