#ifndef MAXSURVIVALEXECUTEREPLANNER_H
#define MAXSURVIVALEXECUTEREPLANNER_H
...
class MaxSurvivalExecuteReplanner_t
{
	int m_nReplan;
...
public:
	// Constructor
	MaxSurvivalExecuteReplanner_t() {}
	MaxSurvivalExecuteReplanner_t(ConnectedGraph_t &g, std::vector<int> currentPath);
